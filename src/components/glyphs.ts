...
const PLATE = 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z|M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z';

/** Lucide: egg, carrot, wheat — by category code. */
const CATEGORY: Record<string, string> = { protein: CAT[0], vegetable: CAT[1], starch: CAT[2] };

export const dishIcon = (styleCode: string | undefined) => (styleCode && DISH[styleCode]) || PLATE;
