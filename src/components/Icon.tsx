interface Props { d: string; size: number; className?: string; style?: React.CSSProperties }
...
export function Icon({ d, size, className, style }: Props) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" strokeWidth={2.75}
