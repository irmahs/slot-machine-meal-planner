...
const SAMPLE: Snapshot = {
  catalogue: [
    ...
    { name: 'Broccoli', category: 'fibre' },
    { name: 'Baby Spinach', category: 'fibre' },
    { name: 'Mushrooms', category: 'fibre' },
...
function sampleBasket(addDays: (days: number) => string): Snapshot {
  return {
    ...
    pantry: [
      ...
      { name: 'Baby Spinach', category: 'fibre', expiresOn: addDays(1), qty: 1, unit: 'bag' },
      { name: 'Broccoli', category: 'fibre', expiresOn: addDays(5), qty: 1, unit: 'piece' },
